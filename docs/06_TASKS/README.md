...
| [TASK-065](TASK-065-stores-on-one-address.md) | Web stores at `pos.chachisoftware.store/s/<store>/`; the owner's "Your stores" by Google; no DNS per store | Built, *this commit*; `demo` live | — |
