...
| [TASK-059](TASK-059-manager-admin.md) | A manager's Admin: every tab but Users, with the owner's parts locked | Built, *this commit* | The store's manager running a backup and the day's settings |
