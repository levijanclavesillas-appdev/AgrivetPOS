...
| [TASK-056](TASK-056-pin-and-touch.md) | A PIN reaches the counter; every counter action is a button for touch | Built, *this commit* | The store's Android tablet at the counter |
