...
| [TASK-060](TASK-060-over-limit-credit.md) | Over the credit limit, approved at the payment screen, by an approval given for it | Built, *this commit* | A manager approving utang past a limit at the store's counter |
