...
| [TASK-069](TASK-069-camera-barcode-scanning.md) | Scan barcodes with the phone's, tablet's or laptop's camera, at the counter and wherever a barcode is typed | Open | The owner's three answers (Android scanner, web decoder, barcode types) |
| [TASK-070](TASK-070-wholesale-and-retail-sari-sari.md) | *Sari-sari & wholesale* at setup: a wholesale switch, pack prices, quick keys, sell by amount, utang customers added at the counter; the first store deployed | Open | The owner's six answers, including which store is first |
