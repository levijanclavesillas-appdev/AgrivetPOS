...
test('this edition\'s own migrations are numbered from 900', () => {
  ...
  assert.deepEqual(edition.map((m) => m.file), ['900_generic_name.sql', '901_licence.sql', '902_product_images.sql', '903_batch_recall.sql', '904_store_industry.sql', '905_pack_barcodes.sql', '906_po_close_short.sql']);
});
